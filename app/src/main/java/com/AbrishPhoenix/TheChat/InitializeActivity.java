...
public class InitializeActivity extends AppCompatActivity {
	...
	private StorageReference fs = _firebase_storage.getReference("files");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_rn_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				d.setMessage("Make sure you are connected to the Internet.");
				d.setPositiveButton("Retry", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						rn.startRequestNetwork(RequestNetworkController.GET, "https://www.google.com", "", _rn_request_listener);
					}
				});
		...
		_auth_create_user_listener = new OnCompleteListener<AuthResult>() {
			...
			public void onComplete(Task<AuthResult> _param1) {
				...
				final String _errorMessage = _param1.getException() != null ? _param1.getException().getMessage() : "";
				if (_success) {
					Helper.showMessage(InitializeActivity.this, "Logged in successfully.");
					...
					Helper.showMessage(InitializeActivity.this, "Restart the app.");
				}
			}
		};
			...
			public void onComplete(Task<AuthResult> _param1) {
				...
				if (_success) {
					...
					if (_errorMessage.equals("There is no user record corresponding to this identifier. The user may have been deleted.")) {
						auth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(InitializeActivity.this, _auth_create_user_listener);
					}
					else {
						SketchwareUtil.showMessage(getApplicationContext(), _errorMessage);
						Helper.showMessage(InitializeActivity.this, "Restart the app.");
	...
	private void initializeLogic() {
		...
		AdFather.initializeAds(this);
		
		_navigationBarColor(ColorHelper.getStringPrimaryColor(InitializeActivity.this));
		_SetStatusBarColor(ColorHelper.getStringPrimaryColor(InitializeActivity.this));
		email = Helper.getEmail(this);
		password = Helper.getId(this);
		timer = new TimerTask() {
			@Override
			public void run() {
	...
	public void _start() {
		if ((FirebaseAuth.getInstance().getCurrentUser() != null)) {
			...
			auth.signInAnonymously().addOnCompleteListener(InitializeActivity.this, _auth_sign_in_listener);
		}
	}
